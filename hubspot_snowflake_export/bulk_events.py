...
def sync_deals(event):
    ...
    try:
        ...
        sf_cursor.executemany("""INSERT INTO DEALS_TEMP (DEAL_ID, DEAL_NAME, DEAL_OWNER, DEAL_OWNER_ID,
            ...
            %(SOLUTION_LEAD_ID)s, %(SOLUTION_LEAD_EMAIL)s, %(SOLUTION_LEAD_NAME)s, %(REVENUE_TYPE)s, %(CURRENCY)s, %(BOOK_LEADS_2026)s, %(BOOK_2026_EMAIL)s, %(OFFERING)s)""",
                              raw_deals)
        ...
        sf_cursor.execute(f"""
            ...
            WHEN NOT MATCHED THEN
                ...
                source.SOLUTION_LEAD_EMAIL, source.SOLUTION_LEAD_NAME, source.REVENUE_TYPE, source.CURRENCY, source.BOOK_LEADS_2026, source.BOOK_2026_EMAIL, source.OFFERING)
        """
                          )
